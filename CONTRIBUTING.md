...
- `feature/<name>` — new functionality (e.g. `feature/voice-webhook`)
...
1. Pick up an open issue (see the [issue tracker](https://github.com/saikumardeepak1/echoflow/issues) and [roadmap](docs/ROADMAP.md)).
